            ...
            <main className="flex-1 flex items-center justify-center p-6">
                <div className="w-full max-w-2xl bg-white dark:bg-white/5 rounded-2xl shadow-xl border border-gray-200 dark:border-white/5 overflow-hidden">
                    <div className="p-6 border-b border-gray-200 dark:border-white/10 flex justify-between items-center">
                        ...
                        <button onClick={handleSaveDraft} className="text-primary font-bold hover:text-primary/80 transition-colors">Brouillons</button>
                    </div>
                    ...
                    <div className="p-6 flex gap-4">
                        ...
                        <div className="flex-1">
                            <textarea
                                ...
                                placeholder={`Quoi de neuf, ${currentUser?.name?.split(' ')[0] || 'Sofia'} ?`}>
                            </textarea>

                            {/* Zone de preview d'image */}
                            <div
                                onClick={toggleMedia}
                                className="mt-4 border-2 border-dashed border-gray-300 dark:border-white/10 rounded-xl p-8 flex flex-col items-center justify-center text-gray-500 dark:text-white/40 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors cursor-pointer">
                    ...
                    <div className="p-6 bg-gray-50 dark:bg-white/5 border-t border-gray-200 dark:border-white/10 flex items-center justify-between">
                        <div className="flex gap-2">
                            <button onClick={toggleMedia} className="p-2 rounded-full bg-black text-white hover:bg-gray-800 dark:bg-gray-800 dark:hover:bg-gray-700 dark:text-gray-100 transition-colors" title="Photo/Video">
                        ...
                        <div className="flex items-center gap-4">
                            <div className="relative">
                                ...
                                {isPrivacyOpen && (
                                    <div className="absolute bottom-full right-0 mb-2 w-32 bg-white dark:bg-[#1E1E1E] rounded-lg shadow-xl border border-gray-200 dark:border-white/10 overflow-hidden z-10">
