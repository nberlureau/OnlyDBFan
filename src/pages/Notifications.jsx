        ...
        <div className="font-display bg-transparent text-gray-900 dark:text-gray-100 min-h-screen flex">
            ...
            <main className="flex-1 max-w-3xl mx-auto p-6">
                ...
                <div className="flex gap-4 mb-6 border-b border-gray-200 dark:border-white/10">
                    ...
                    <button className="pb-3 px-2 border-b-2 border-transparent text-gray-500 dark:text-gray-400 font-medium hover:text-gray-900 dark:hover:text-white transition-colors">Mentions</button>
                    <button className="pb-3 px-2 border-b-2 border-transparent text-gray-500 dark:text-gray-400 font-medium hover:text-gray-900 dark:hover:text-white transition-colors">Abonnements</button>
                </div>

                <div className="flex flex-col gap-2">
                    <h3 className="text-sm font-bold text-gray-500 dark:text-gray-400 mt-2 mb-2">Aujourd'hui</h3>

                    {/* Carte de notification adaptative */}
                    <div className="flex items-start gap-4 p-4 rounded-2xl bg-white dark:bg-[#1E1E1E] border border-gray-200 dark:border-[#333333] hover:border-primary-notifications/20 transition-colors cursor-pointer relative group shadow-sm dark:shadow-none">
                    ...
                    <h3 className="text-sm font-bold text-gray-500 dark:text-gray-400 mt-6 mb-2">Hier</h3>

                    {/* Carte de notification "lue" adaptative */}
                    <div className="flex items-start gap-4 p-4 rounded-2xl bg-transparent border border-gray-200 dark:border-white/5 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors cursor-pointer relative group">
                        <div className="relative shrink-0">
                            <div className="bg-center bg-no-repeat aspect-square bg-cover rounded-full size-12"
                            ...
                            <div className="absolute -bottom-1 -right-1 bg-green-500 text-white rounded-full p-0.5 border-2 border-white dark:border-[#050816]">
                        ...
                        <div className="flex-1">
                            ...
                            <span className="text-xs text-gray-500 dark:text-gray-400 mt-1 block">il y a 1 jour</span>
                        </div>
                    ...
                    <div className="flex items-start gap-4 p-4 rounded-2xl bg-transparent border border-gray-200 dark:border-white/5 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors cursor-pointer relative group">
                        <div className="relative shrink-0">
                            ...
                            <div className="absolute -bottom-1 -right-1 bg-purple-500 text-white rounded-full p-0.5 border-2 border-white dark:border-[#050816]">
